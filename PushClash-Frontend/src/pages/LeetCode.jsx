      ...
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex justify-center">
          <button
            type="submit"
            disabled={isRoasting}
            className={`bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold py-2 sm:py-3 px-6 sm:px-8 rounded-lg transition duration-300 flex items-center text-sm sm:text-base ${isRoasting ? 'opacity-75 cursor-not-allowed' : ''}`}
          >
            {isRoasting ? (
              <>
